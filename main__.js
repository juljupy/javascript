...
Ext.onReady(function(){
    ...
    var gridRegs = new Ext.grid.GridPanel({//Definimos la clase gridRegs
        style : {
            margin : '10px'
        },
        title : 'Registrados torvic',
        tbar  : [{
            text : 'Nuevo'
        },'-',{
            text : 'Modificar'
        ...
        store : new Ext.data.JsonStore({
            /*url : 'conexion.php',
            fields : [{name : 'id'},{name : 'nombre'},{name : 'apellido'},{name : 'direccion'},{name: 'telefono'}],
            root: 'datos',//carga el objeto creado en el php
            totalProperty : 'total',//Para que me arroje el total de registros, para uso del paginado
	...
	new Ext.Viewport({
		...
		items : [{
			...
			region: 'center',
			margins: '5 0 5 0',
			items : [gridRegs]//Se llama a la clase girdRegs que se creó anteriormente
		},{
			title : 'Norte',
			border: false,
			region: 'north',
